...
export async function AddDispatchLimits(
  db: D1QB,
...
export async function GetDispatchLimitFromScript(
  db: D1QB,
  scriptName: string,
): Promise<ResultOne> {
...
export async function AddOutboundWorker(
  db: D1QB,
...
export async function GetOutboundWorkerFromScript(
  db: D1QB,
  scriptName: string,
): Promise<ResultOne> {
  return await db.fetchOne({
